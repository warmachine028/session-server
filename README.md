...
<div align=center>
    <a href="https://github.com/warmachine028/session-server">
        <img width="200" src="https://img.icons8.com/?size=1000&id=46874" alt="session-server">
    </a>
...
# [Session Server](https://github.com/warmachine028/session-server)
...
2. Go to [**Security**](https://github.com/warmachine028/session-server/security) tab.
3. Click on **Security Overview**.
4. Click on `Enable Dependabot alerts` button.

- Enable Code Scanning Alerts

1. Go to [Code security and analysis](https://github.com/SrijaAdhya12/session-server/settings/security_analysis#code_scanning_settings) section in settings.
